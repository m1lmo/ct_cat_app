...
import 'package:wiet_test_app/core/constants/enum/notify_type.dart';
import 'package:wiet_test_app/core/helper/ticker_provider_service.dart';
import 'package:wiet_test_app/main.dart';

/// This class is used to show the notification
class CNotify {
  /// This method is used to create the notification
  CNotify({
    this.duration,
    this.title,
